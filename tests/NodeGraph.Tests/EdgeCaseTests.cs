...
public class EdgeCaseTests
{
	...
	public void PinAttribute_WithNullMember_ThrowsException()
	{
		...
		Assert.ThrowsExactly<InvalidOperationException>(() => attribute.InitializeTypeInfo(null!));
	}
	...
	public void PinAttribute_WithUnsupportedMemberType_ThrowsException()
	{
		...
		Assert.ThrowsExactly<InvalidOperationException>(() => attribute.InitializeTypeInfo(unsupportedMember));
	}
