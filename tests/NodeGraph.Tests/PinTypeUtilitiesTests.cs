...
public class PinTypeUtilitiesTests
{
	...
	{
		Assert.ThrowsExactly<ArgumentNullException>(() => PinTypeUtilities.RequiresConversion(null!, typeof(int)));
		Assert.ThrowsExactly<ArgumentNullException>(() => PinTypeUtilities.RequiresConversion(typeof(int), null!));
	}

	[TestMethod]
	public void IsLossyConversion_WithNullArguments_ThrowsArgumentNullException()
	{
		Assert.ThrowsExactly<ArgumentNullException>(() => PinTypeUtilities.IsLossyConversion(null!, typeof(int)));
		Assert.ThrowsExactly<ArgumentNullException>(() => PinTypeUtilities.IsLossyConversion(typeof(int), null!));
	}
}
