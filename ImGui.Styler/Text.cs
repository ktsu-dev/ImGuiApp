...
public static partial class Text
{
	...
	public static partial class Color
	{
		...
		public static class Definitions
		{
			...
			/// </summary>
			public static ImColor Normal { get; set; } = Palette.Neutral.White;

			/// <summary>
			/// Gets or sets the error text color.
			/// </summary>
			public static ImColor Error { get; set; } = Palette.Basic.Red;

			/// <summary>
			/// Gets or sets the warning text color.
			/// </summary>
			public static ImColor Warning { get; set; } = Palette.Basic.Yellow;

			/// <summary>
			/// Gets or sets the info text color.
			/// </summary>
			public static ImColor Info { get; set; } = Palette.Basic.Cyan;

			/// <summary>
			/// Gets or sets the success text color.
			/// </summary>
			public static ImColor Success { get; set; } = Palette.Basic.Green;
		}
